...
DROP POLICY IF EXISTS live_chat_unblocked ON public.live_chat_messages;
...
DROP POLICY IF EXISTS live_chat_safe_insert ON public.live_chat_messages;
...
DROP POLICY IF EXISTS pins_owned_product ON public.live_pinned_products;
